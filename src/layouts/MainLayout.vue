...
const isAdminLoggedIn = computed(() => localStorage.getItem('isAdmin') === 'true');
      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse justify-content-end">
          <ul class="navbar-nav align-items-center">
            ...
            <li v-if="!isAdminLoggedIn" class="nav-item-bs">
              <a class="nav-link animated-btn-bs" href="#" @click.prevent="handleAdminNav" style="--clr: #ff9800">
                <span>Login Admin</span>
                <i></i>
              </a>
            </li>
            <li v-else class="nav-item-bs dropdown position-relative" @mouseleave="closeAdminDropdown">
              <a class="nav-link animated-btn-bs dropdown-toggle d-flex align-items-center" href="#" @click.prevent="toggleAdminDropdown" style="--clr: #ff9800" role="button">
                <span class="admin-name-navbar">Admin</span>
                <i class="bi bi-caret-down-fill ms-1"></i>
              </a>
              <ul v-if="showAdminDropdown" class="dropdown-menu show admin-dropdown-menu">
                <li><a class="dropdown-item" href="#" @click.prevent="handleAdminLogout">Logout Akun</a></li>
                <li><a class="dropdown-item" href="#" @click.prevent="handleAdminSwitch">Beralih Akun</a></li>
              </ul>
            </li>
          </ul>
        </div>
    ...
    >
      ...
      <div class="offcanvas-body">
        <ul class="nav flex-column">
          ...
          <li class="nav-item-bs w-100" v-if="!isAdminLoggedIn">
            <a class="nav-link sidebar-btn-bs" href="#" @click.prevent="handleAdminNav" style="--clr: #ff9800">
              <span>Admin</span>
              <i></i>
            </a>
          </li>
          <li class="nav-item-bs w-100" v-else>
            <div class="dropdown w-100">
              <a class="nav-link sidebar-btn-bs dropdown-toggle w-100" href="#" @click.prevent="toggleAdminDropdown" style="--clr: #ff9800" role="button">
                <span>Admin</span>
                <i></i>
              </a>
              <ul v-if="showAdminDropdown" class="dropdown-menu show admin-dropdown-menu w-100" style="position: static;">
                <li><a class="dropdown-item" href="#" @click.prevent="handleAdminLogout">Logout Akun</a></li>
                <li><a class="dropdown-item" href="#" @click.prevent="handleAdminSwitch">Beralih Akun</a></li>
              </ul>
            </div>
...
/* Tambahan agar dropdown menu tampil rapi */
.dropdown-menu {
  min-width: 150px;
  background: #222;
  color: #fff;
...
/* Tambahan untuk admin dropdown menu */
.admin-name-navbar {
  color: #fff;
  font-weight: 500;
  font-size: 1.05rem;
