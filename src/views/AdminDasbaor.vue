<template>
  <section class="admin-dashboard-bs">
    <div class="container py-4 py-md-5">
      <h2 class="section-title-bs text-center">Input Data Produk</h2>
        ...
        <div class="col-lg-7">
          <form class="admin-card-bs p-4" @submit.prevent="submitForm">
            ...
            <div class="mb-3">
              ...
              <input v-model="stok" type="number" class="form-control" required min="0" />
            </div>
            <div class="mb-3">
            ...
            <p v-if="success" class="success-bs mt-3">Data produk berhasil disimpan!</p>
          </form>
        </div>
      </div>
    </div>
