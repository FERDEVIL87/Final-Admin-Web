<template>
  <section class="pc-list-section-bs">
    <div class="container py-4 py-md-5">
      <h2 class="section-title-bs text-center">Input Data PC Parts</h2>
        ...
        <div class="col-lg-7">
          <form class="admin-card-bs p-4" @submit.prevent="submitForm">
            ...
            <div class="mb-3">
              ...
              <textarea v-model="spesifikasi" class="form-control" rows="3" placeholder="Contoh: Socket: AM4, Speed: 3200MHz, ..."></textarea>
            </div>
            <button class="login-btn-bs w-100" type="submit">Simpan Data</button>
            <p v-if="success" class="success-bs mt-3">Data part berhasil disimpan!</p>
          </form>
        </div>
      </div>
      <div class="row justify-content-center mt-5">
        <div class="col-12">
          <div class="admin-card-bs p-3">
            <h4 class="mb-3" style="font-family:'Orbitron',sans-serif;color:var(--primary-color);">Daftar PC Parts</h4>
            <div class="table-responsive">
              <table class="table table-dark table-striped align-middle table-bordered" style="background:var(--background-section);color:var(--text-light);">
                ...
                <tbody>
                  <tr v-for="(item, idx) in partList" :key="idx">
                    <td>{{ idx + 1 }}</td>
                    <td>{{ item.nama }}</td>
